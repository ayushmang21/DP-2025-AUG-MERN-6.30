...
const AddProductSchema = Yup.object().shape({
    ...
    description: Yup.string().required('Email chahiye bhai..!'),
    price: Yup.number().required('Password chahiye bhai..!'),
    stock: Yup.boolean().required('Confirm your password'),
    category: Yup.string().required('Email chahiye bhai..!')
})
                    ...
                    <form onSubmit={productForm.handleSubmit}>
                        <div className="grid gap-y-4">
                            ...
                            <div>
                                ...
                                {
                                    (productForm.errors.email && productForm.touched.email) && (
                                        <p className='text-sm text-red-600 font-medium mt-2'>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name="password"
                                        onChange={productForm.handleChange}
                                        value={productForm.values.password}
                                        className="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        required=""
                                ...
                                {
                                    (productForm.errors.password && productForm.touched.password) && (
                                        <p className='text-sm text-red-600 font-medium mt-2'>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        onChange={productForm.handleChange}
                                        value={productForm.values.confirmPassword}
                                        className="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                        required=""
                                ...
                                {
                                    (productForm.errors.confirmPassword && productForm.touched.confirmPassword) && (
                                        <p className='text-sm text-red-600 font-medium mt-2'>
                                            {productForm.errors.confirmPassword}
                                        </p>
                                    )
                                }
                            </div>
